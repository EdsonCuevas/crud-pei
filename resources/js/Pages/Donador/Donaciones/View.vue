      ...
      <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">${{ props.donacion.value }}MXN</p>
            </div>
            <div>
        ...
        <div class="mt-6 space-y-4">
          ...
          <div class="flex justify-between mt-6">
            <button @click="descargarPDF" class="bg-[#004481] text-white px-6 py-2 rounded-md hover:bg-[#003366] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#004481] transition duration-300">
              Descargar PDF
            </button>
            <button @click="enviarPorEmail" class="bg-green-500 text-white px-6 py-2 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-300">
              Enviar por Email
            </button>
          </div>
        </div>
